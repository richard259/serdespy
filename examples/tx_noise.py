...
sdp.simple_eye(RX.signal, samples_per_symbol*3, 1000, TX.UI/TX.samples_per_symbol, "Eye Diagram with CTLE and noise")

#%%
RX.FFE(ffe_tap_weights, n_taps_pre)

sdp.simple_eye(RX.signal, samples_per_symbol*3, 800, TX.UI/TX.samples_per_symbol, "Eye Diagram after FFE")

RX.pam4_DFE(dfe_tap_weights)

sdp.simple_eye(RX.signal[64*300:], samples_per_symbol*3, 800, TX.UI/TX.samples_per_symbol, f"Eye Diagram after FFE, and DFE")